...
# Bronze layer dir 
GNEWS_BRONZE_MIDTERMS_FOLDER_ID = environ['GNEWS_BRONZE_MIDTERMS_FOLDER_ID']

MIDTERMS_FILES_PATH = '../../../DATA/gnews/midterms/stage/'
...
for file_path in file_paths:
    with open(file_path, 'r') as f:
        ...
        fh = io.BytesIO(bytes(json.dumps(file_dict), 'utf-8'))
        ...
        file_metadata = {
            'name' :file_name
            , 'parents': [GNEWS_BRONZE_MIDTERMS_FOLDER_ID]
